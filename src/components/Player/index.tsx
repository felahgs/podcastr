...
export default function Player() {
  ...
  function setupProgressListener() {
    ...
    // Add a listener to the audioElement. When the time change the progress
        ...
        <footer className={!episode ? styles.empty : ''}>
          ...
          {episode && (
            <audio 
              ...
              onLoadedMetadata={setupProgressListener} //Disparado quando os dados do áudio são carregados
            />
          )}
